    ...
    return(
      <div className='row'>
        ...
        <div className='col s12 m6 l3'>
          ...
          <br />
          <button className="fa fa-envelope" aria-hidden="true" onClick={this.handleSubmit}></button>
          <button className="fa fa-github" aria-hidden="true" onClick={this.handleSubmit}></button>
          <button className="fa fa-linkedin-square" aria-hidden="true" onClick={this.handleSubmit}></button>
        </div>
        <div className='col s12 m6 l3'>
